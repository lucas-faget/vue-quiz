...
<main class="flex flex-col justify-center items-center mt-20">
    <div class="w-full max-w-lg">
        <Tabs.Root value="join" class="rounded-card border-muted bg-background-alt shadow-card w-full border p-3">
            <Tabs.List
            ...
            <Tabs.Content value="join" class="select-none pt-3">
            ...
            <Tabs.Content value="create" class="select-none pt-3">
                <div class="flex flex-col gap-8 pt-4">
                    <h1 class="text-4xl font-bold">Let's Play Quiz</h1>
