...
{#snippet roomForm(roomAction: RoomAction, text: string, buttonText: string)}
    <form onsubmit={handleRoomAction}>
        <div class="flex flex-col gap-8 pt-4">
            ...
            <div class="flex w-full flex-col gap-1.5">
                <Label.Root id="player-name-label" for="player-name" class="block select-none text-sm font-medium">
                    Player Name
                </Label.Root>
                <input
